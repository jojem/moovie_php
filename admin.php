		...
		<div class="content">
			<div>
			  <form action="insert_film.php" id= "insert_form" method="post">
			    ...
			    <div class="row">
			    	<input type="number" step="0.1" id="rating" name="rating" placeholder="Enter film rating">
			    	<input type="number" id="runtime" name="runtime" placeholder="Enter film runtime in minutes">
			    </div>
			    ...
			    <select multiple id="genre" name="genre[]">
				  ...
				  <textarea rows="4" cols="50" name="storyline" id="storyline" form="insert_form"> Storyline</textarea><br>

				  <label for="taglines">Taglines</label><br>
